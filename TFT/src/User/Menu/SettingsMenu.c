...
void menuInfo(void)
{
  ...
  //draw titles
  GUI_DispString(0, version[0].y0, (uint8_t *)"메인 Fw  :");
  GUI_DispString(0, version[1].y0, (uint8_t *)"기계     :");
  GUI_DispString(0, version[2].y0, (uint8_t *)"보드     :");
  GUI_DispString(0, version[3].y0, (uint8_t *)"TFT Fw   :");
