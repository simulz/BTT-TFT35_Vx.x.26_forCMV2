...
void menuScreenSettings(void)
{
  ...
  // icon                       label
   {
    ...
    //{ICON_LANGUAGE,           LABEL_LANGUAGE}, //cremaker
  ...
  #ifdef LCD_LED_PWM_CHANNEL
    screenSettingsItems.items[KEY_INDEX_BRIGHTNESS-1].icon = ICON_BRIGHTNESS;
    screenSettingsItems.items[KEY_INDEX_BRIGHTNESS-1].label.index = LABEL_LCD_BRIGHTNESS;
  #endif
  //load buzzer icon
  #ifdef BUZZER_PIN
    screenSettingsItems.items[KEY_INDEX_BUZZER-1].icon = ICON_SOUND;
    screenSettingsItems.items[KEY_INDEX_BUZZER-1].label.index = LABEL_SOUND;
  #endif

  #ifdef ST7920_EMULATOR
    // LCD12864 background color
    screenSettingsItems.items[KEY_INDEX_EMULATOR-1].icon = ICON_MARLIN_MODE;
    screenSettingsItems.items[KEY_INDEX_EMULATOR-1].label.index = LABEL_MARLIN_MODE_SETTINGS;
  #endif
