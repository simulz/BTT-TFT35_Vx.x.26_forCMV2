...
static const char errormagicKr[] = "에러:";
static const char echomagicKr[]  = "알림:";

#define ACK_MAX_SIZE 512

#define SGR_RESULT_MAX 80
#define SGR_RESULT_MIN 25 //cremaker
#define SGR_RESULT_NOISE 10 //cremaker

extern uint8_t portNum[SERIAL_PORT_COUNT];
