...
#define W25QXX_SECTOR_SIZE (0x1000) // 4096-4K
  ...
  #define STATUS_CM_LOGO_SIZE       0x14000
  #define PRINTING_MAIN_LOGO_SIZE   0x15000
  #define INFOBOX_MAX_SIZE          0x10000    //0xB000
  #define PSCNUM_ICON_MAX_SIZE       0x2000
...
#define STATUS_CM_LOGO_ADDR     (ICON_ADDR(ICON_PREVIEW) + ICON_MAX_SIZE)
#define PRINTING_MAIN_LOGO_ADDR (STATUS_CM_LOGO_ADDR + STATUS_CM_LOGO_SIZE)
#define INFOBOX_ADDR            (PRINTING_MAIN_LOGO_ADDR + PRINTING_MAIN_LOGO_SIZE)   // total byte size 0xA7F8
#define PSCNUM_ICON_START_ADDR  (INFOBOX_ADDR + INFOBOX_MAX_SIZE)
#define PSCNUM_ICON_ADDR(num)   ((num)*PSCNUM_ICON_MAX_SIZE + PSCNUM_ICON_START_ADDR)
...
#define FLASH_USED              (PSCNUM_ICON_ADDR(10) + PSCNUM_ICON_MAX_SIZE)   //currently small icons are not used
