 ...
 *          HUNGARIAN,  TURKISH,  GREEK,       SLOVENIAN,  CATALAN,   TRAD_CHINESE,  UKRAINIAN,    KOREAN
 */
#define DEFAULT_LANGUAGE KOREAN  // Default: ENGLISH
...
#define PREHEAT_LABELS   {"PLA", "PETG", "ABS", "TPU", "WOOD", "NYLON"}
#define PREHEAT_HOTEND   {200,   240,    230,   220,    170,    250}
#define PREHEAT_BED      {60,    70,     90,    50,     50,     90}

#define HEAT_MAX_TEMP    {275,       275,       275,       275,       275,       275,       150,    60}
#define HEAT_SIGN_ID     {"노즐:",     "T1:",     "T2:",     "T3:",     "T4:",     "T5:",     "B:",   "C:"} //cremaker
#define HEAT_DISPLAY_ID  {"노즐",      "T1",      "T2",      "T3",      "T4",      "T5",      "베드",  "Chamber"} //cremaker
...
#define FAN_DISPLAY_ID   {      "팬",      "F1",      "F2",      "F3",      "F4",      "F5",     "CtL",     "CtI" };
...
#define SPEED_ID {"속도", "압출"}  // (speed, flow rate) //cremaker
...
// First layer height, Z value
#define FIRST_LAYER_HEIGHT 0.3
...
// End for auto print G-code - run this G-code after finishing print in AutoPrinting State
#define PRINT_END_AUTOPRINT_GCODE "M104 S0\nM140 S0\nM107\nM18 X Z E\n"


/*   
 * port enable
 *
 * set to reduce noise, wrong data in uart ports
 * 
 * Options: [0: Disabled, 1: Enabled]
 */
#define PORT_1_ON 1 // must set 1
#define PORT_2_ON 0
#define PORT_3_ON 0
#define PORT_4_ON 0
...
/*
 * in preheated and not input, if keep temperature for 15 min, automatically turn off temperature
 * Options: [0: Disabled, 1: Enabled]
 */
#define TEMP_AUTO_OFF_IN_NO_INPUT 1

/*
 * in homing Z, protect Z any Clash
 * Options: [0: Disabled, 1: Enabled]
 */
#define Z_HOMING_PROTECT 1
